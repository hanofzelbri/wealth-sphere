...
const EditInvestment: React.FC<EditInvestmentProps> = ({ investment: initialInvestment, onEditInvestment, onCancel }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white p-8 rounded-xl max-w-md w-full">
        <h3 className="text-2xl font-semibold text-gray-800 mb-6">Edit Investment</h3>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex justify-end space-x-4 mt-6">
            ...
            <Button type="submit" className="px-4 py-2 bg-indigo-600 text-white hover:bg-indigo-700 rounded-md">Save Changes</Button>
          </div>
        </form>
      </div>
    </div>
