...
export const coingeckoControllerUpdateCoinPricesQueryKey = (options?: Options) => [
    createQueryKey('coingeckoControllerUpdateCoinPrices', options)
];

export const coingeckoControllerUpdateCoinPricesOptions = (options?: Options) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
...
export const coingeckoControllerUpdateMarketChartDataQueryKey = (options?: Options) => [
    createQueryKey('coingeckoControllerUpdateMarketChartData', options)
];

export const coingeckoControllerUpdateMarketChartDataOptions = (options?: Options) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
